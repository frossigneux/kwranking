# -*- coding: utf-8 -*-
#
# Kwranking documentation build configuration file, created by
...
def write_autodoc_index():
    ...
    EXCLUDED_MODULES = ['kwranking.tests']
    CURRENT_SOURCES = {}
...
htmlhelp_basename = 'Kwrankingdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'Kwranking.tex', u'Kwranking Documentation',
...
man_pages = [
    ('index', 'Kwranking', u'Kwranking Documentation',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Kwranking', u'Kwranking Documentation', u'OpenStack',
     'Kwranking', 'One line description of project.', 'Miscellaneous'),
]
